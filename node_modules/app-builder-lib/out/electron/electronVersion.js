...
async function computeElectronVersion(projectDir, projectMetadata) {
  ...
  if (((_a = dependency) === null || _a === void 0 ? void 0 : _a.name) === "electron-nightly") {
  ...
  } else if (((_b = dependency) === null || _b === void 0 ? void 0 : _b.version) === "latest") {
  ...
  const version = (_c = dependency) === null || _c === void 0 ? void 0 : _c.version;
